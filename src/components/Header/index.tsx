...
export default function Header2() {
	...
	return (
		<div className='flex justify-center bg-red-700 w-full text-white p-8' onMouseLeave={() => setOpen(false)}>
					...
					<ul className="flex text-xl space-x-16">
						...
						<li className='rounded-sm'>
							<div className=" pl-1 mb-1">
								...
								<ul 
									className={`absolute bg-red-700 border border-gray-300 ${!open && 'scale-0'} p-2 origin-top duration-300`}
